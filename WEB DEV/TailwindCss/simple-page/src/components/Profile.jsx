...
function Profile({url}){
  return <div className="flex flex-col dark:bg-gray-600 bg-white shadow-lg h-96 w-5/6 items-center justify-center gap-5 rounded-xl z-10 absolute left-[9%] -top-10">
